...
namespace YoutubeExplode.Tests
{
    ...
    public class YoutubeClientIntegrationTests
    {
        ...
        public async Task GetVideoInfoAsync_UnsignedUnrestricted_Test()
        {
            ...
            // Captions
            Assert.IsNotNull(videoInfo.Captions);
            Assert.AreEqual(0, videoInfo.Captions.Length);
        }
        ...
        public async Task GetVideoInfoAsync_SignedUnrestricted_Test()
        {
            ...
            // Captions
            Assert.IsNotNull(videoInfo.Captions);
            Assert.AreEqual(1, videoInfo.Captions.Length);
            Assert.AreEqual("en", videoInfo.Captions[0].Language);
            Assert.IsFalse(videoInfo.Captions[0].IsAutoGenerated);
        }
