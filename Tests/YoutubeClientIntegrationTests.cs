...
namespace YoutubeExplode.Tests
{
    ...
    public class YoutubeClientIntegrationTests
    {
        ...
        public async Task GetPlaylistInfoAsync_Mix_Test()
        {
            ...
            var playlistInfo = await _client.GetPlaylistInfoAsync("RD1hu8-y6fKg0");
        ...
        public async Task GetPlaylistInfoAsync_Liked_Test()
        {
            ...
            var playlistInfo = await _client.GetPlaylistInfoAsync("LLEnBXANsKmyj2r9xVyKoDiQ");
        ...
        public async Task GetPlaylistInfoAsync_Favorites_Test()
        {
            ...
            var playlistInfo = await _client.GetPlaylistInfoAsync("FLEnBXANsKmyj2r9xVyKoDiQ");
